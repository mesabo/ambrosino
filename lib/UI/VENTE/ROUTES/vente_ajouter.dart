...
class VenteAjouterPage extends StatefulWidget {
  final String title;

  VenteAjouterPage(this.title);

  @override
  _VenteAjouterPageState createState() => _VenteAjouterPageState();
}

class _VenteAjouterPageState extends State<VenteAjouterPage> {
  int _radioValue;
  var echo;
