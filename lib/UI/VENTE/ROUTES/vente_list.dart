...
class VenteListPage extends StatefulWidget {
  final String title;

  VenteListPage(this.title);

  @override
  _VenteListPageState createState() => _VenteListPageState();
}

class _VenteListPageState extends State<VenteListPage> {
    ...
    return new Slidable(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          title:
              Text(('${_searchProduct[i].article}  ${_searchProduct[i].desc}')),
    ...
    return new Slidable(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          title:
              Text(('${_produits[index].article}   ${_produits[index].desc}')),
      ...
      secondaryActions: <Widget>[
        ...
        IconSlideAction(
          ...
          icon: Icons.more_horiz,
          onTap: () async {
            await buildEasyDialog('${_produits[index].article}',
                    '${_produits[index].prixu}', '${_produits[index].desc}')
                .show(context);
            print('plus');
          },
        ),
  ...
  EasyDialog buildEasyDialog(String article, String prix, String description) {
    return EasyDialog(
        ...
        title: Text(
          ...
          style: TextStyle(
              fontWeight: FontWeight.bold, fontFamily: 'Exo', fontSize: 24),
          textScaleFactor: 1.2,
        ),
        ...
        contentList: [
          Column(
            ...
            children: <Widget>[
              SuperRichText(
                text:
                    'Le client *$article* a commandé oo220oo packets à rr${prix}rr, ll${description}ll',
                ...
                othersMarkers: [
                  ...
                  MarkerText(
                      marker: 'rr', style: TextStyle(color: Colors.redAccent)),
                  MarkerText.withUrl(marker: 'll', urls: [
